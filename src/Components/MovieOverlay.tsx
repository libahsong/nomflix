...
function MovieOverlay(props: {
  ...
  const setOverlayClick = useSetRecoilState(overlayClickedState);
  ...
  return (
    <>
      <AnimatePresence key="overlayAnimation">
        <Overlay
              ...
              <>
                ...
                <BigContainer>
                  <BigOverview>
                    ...
                    <span>
                      {details?.runtime ? Math.floor(details?.runtime / 60) : 0}
                      h{details?.runtime ? details?.runtime % 60 : 0}m
                    </span>
